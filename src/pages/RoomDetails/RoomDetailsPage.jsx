      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <p className="text-gray-600 mb-2"><strong>Room Name:</strong> {room.name}</p>
            <p className="text-gray-600 mb-2"><strong>Price:</strong> {room.price}</p>
            <p className="text-gray-600 mb-4"><strong>Description:</strong> {room.description}</p>

            <div className="mb-4">
              <label className="block text-gray-600 mb-2">Select Booking Date:</label>
              <DatePicker
            ...
            {bookingError && <p className="text-red-500 text-sm mb-2">{bookingError}</p>}
