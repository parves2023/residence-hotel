  ...
  return (
    <section className="text-gray-600 body-font relative">
      ...
      <div className="container px-5 py-24 mx-auto flex">
        <div className="lg:w-1/3 md:w-1/2 bg-card rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative  shadow-md">
          <h2 className="text-cta-text text-lg mb-1 font-medium title-font font-sans">Feedback</h2>
